...
{
    public partial class SeleccionarTipoPrograma : Form
    {
        public SeleccionarTipoPrograma()
        {
            InitializeComponent();
        }
        ...
        private void SeleccionarTipoPrograma_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
        ...
        private void datosListar_DoubleClick(object sender, EventArgs e)
        {
            ...
            string par1, par2;
            par1 = Convert.ToString(this.datosListar.CurrentRow.Cells["tipo_programa_id"].Value);
            par2 = Convert.ToString(this.datosListar.CurrentRow.Cells["nombre_tipo"].Value);
            form.setTipoPrograma(par1, par2);
            this.Hide();
        }
    }
