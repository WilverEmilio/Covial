...
{
    public partial class SeleccionarContratistaOrdenPago : Form
    {
        public SeleccionarContratistaOrdenPago()
        {
            InitializeComponent();
        }
        ...
        private void SeleccionarContratistaOrdenPago_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
