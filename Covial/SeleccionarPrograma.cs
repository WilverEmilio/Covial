...
namespace Presentation
{
    public partial class SeleccionarPrograma : Form
    {
        ...
        private void datosListar_DoubleClick(object sender, EventArgs e)
        {
            ...
            string par1, par2;
            par1 = Convert.ToString(this.datosListar.CurrentRow.Cells["programa_id"].Value);
            par2 = Convert.ToString(this.datosListar.CurrentRow.Cells["nombre_programa"].Value);
            form.setPrograma(par1, par2);
            this.Hide();
        }
    }
}
